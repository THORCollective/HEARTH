---
category: Embers
hypothesis: Adversaries are automatically exfiltrating email data using email forwarding
  rules.
id: B007
notes: Email forwarding rules may be disabled in your organization, it may be beneficial
  to see what rules were setup regardless of success to identify potential malicious
  activity.
submitter:
