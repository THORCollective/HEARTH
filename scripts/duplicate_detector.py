...
"""
    ...
    logger.info(f"Max Similarity: {result.max_similarity_score:.1%}")
    logger.info(f"Similar Hunts: {result.similar_hunts_count}")
    logger.info(f"Recommendation: {result.recommendation}")
    logger.info(f"Confidence: {result.confidence:.0%}")
    logger.info("GitHub Comment:")
    logger.info(detector.generate_github_comment(result))
