...
const HUNTS_DATA = [
  {
    ...
    "created": "2024-07-17T13:59:53-07:00"
  },
  {
    "id": "B002",
    "category": "Embers",
    ...
    "created": "2024-10-06T12:40:40-07:00"
  },
  {
    "id": "B003",
    "category": "Embers",
    ...
    "created": "2024-10-06T15:38:48-07:00"
  },
  {
    "id": "B004",
    "category": "Embers",
    ...
    "created": "2024-10-20T10:13:48-04:00"
  },
  {
    "id": "B005",
    "category": "Embers",
    ...
    "created": "2024-11-06T20:24:48-07:00"
  },
  {
    "id": "B006",
    "category": "Embers",
    ...
    "created": "2024-12-05T18:36:54-06:00"
  },
  {
    "id": "B007",
    "category": "Embers",
    ...
    "created": "2024-12-05T18:44:05-06:00"
  },
  {
    "id": "B008",
    "category": "Embers",
    ...
    "created": "2025-03-13T20:49:10-07:00"
  },
  {
    "id": "B009",
    "category": "Embers",
  ...
  },
  {
    ...
    "created": "2026-02-10T20:58:20-07:00"
  },
  {
    "id": "B013",
    "category": "Embers",
    ...
    "created": "2026-04-19T10:55:16-05:00"
  },
  {
    "id": "B014",
    "category": "Embers",
    ...
    "created": "2026-04-19T12:05:59-05:00"
  },
  {
    "id": "B015",
    "category": "Embers",
  ...
  },
  {
    ...
    "created": "2026-04-19T15:01:09-05:00"
  },
  {
    "id": "B017",
    "category": "Embers",
    ...
    "created": "2026-05-23T15:05:23-05:00"
  },
  {
    "id": "B018",
    "category": "Embers",
    ...
    "created": "2026-05-30T06:14:36-05:00"
  },
  {
    "id": "B019",
    "category": "Embers",
  ...
  },
  {
    ...
    "created": "2026-06-04T12:58:05-05:00"
  },
  {
    "id": "B021",
    "category": "Embers",
    ...
    "created": "2026-06-06T06:11:55-05:00"
  },
  {
    "id": "B022",
    "category": "Embers",
  ...
  },
  {
    ...
    "created": "2026-06-14T22:34:37-05:00"
  },
  {
    "id": "B024",
    "category": "Embers",
  ...
  },
  {
    ...
    "tactic": "Lateral Movement",
    "notes": "PLATFORM: Windows / Active Directory. BASELINE FIRST (Embers). Source: Unit 42, \"The Gentlemen Ransomware,\" which exploits CVE-2025-33073 (Windows SMB Client NTLM reflection EoP) and internal service vulns for lateral movement and recommends enforcing SMB signing + disabling SMBv1. This is a high-level brief with no forensic command lines, so the hunt is built as an authentication baseline rather than an IOC match.\n\nDATA COLLECTION FIELDS (per event): source host, destination host, account name, account type (user vs machine account `HOST$`), logon type (3 = network), authentication package (NTLM vs Kerberos), NTLM version, SMB dialect, SMB signing negotiated (yes/no), share/pipe accessed, process/service context, timestamp. TELEMETRY: Windows Security 4624 / 4625 (network logon, capture `Authentication Package` = NTLM and the source/destination), 4776 (NTLM credential validation), 5140 / 5145 (share and detailed file-share access, esp. IPC$ and named pipes used by relay tooling — svcctl, atsvc, winreg), and SMBServer/SMBClient operational logs for dialect + signing. Sysmon EID 3 (network connect on 445) and EID 18 (named-pipe connect) enrich the picture.\n\nCOLLECTION WINDOW: 30 days per host/account to learn normal peers, auth package, and signing posture. DELIVERABLE: a per-host/per-account allowlist of expected SMB/NTLM authentication — which accounts authenticate to which destinations, whether they use NTLM or Kerberos, and whether signing is enforced — plus a baseline of the small, predictable set of hosts that legitimately see machine-account inbound SMB.\n\nIMMEDIATE FLAGS (do not wait for the baseline to finish): (1) a host authenticating to ITSELF via network NTLM (source host == destination host, logon type 3) — the reflection tell; (2) a machine account (`HOST$`) authenticating to a host other than a domain controller or its normal management peers; (3) SYSTEM-context SMB sessions initiated to peers the machine never contacts, immediately followed by service creation (7045) or named-pipe access to `svcctl`/`atsvc`; (4) NTLM where Kerberos is expected (unsigned NTLM to an internal host that normally uses Kerberos), a hallmark of coercion/relay; (5) inbound SMB with signing NOT negotiated on hosts where policy requires it. CROSS-REF: enables lateral-movement Flames/Alchemy hunts (Impacket service-exec, PsExec `-s`, DCOM/WMI alternate lateral movement) and complements credential-access hunts on the DC.",
    "tags": [
      "lateral_movement",
      "windows",
      "active_directory",
  ...
  },
  {
    ...
    "tactic": "Collection",
    "notes": "PLATFORM: Network Devices (SNMP-managed routers/switches). BASELINE FIRST (Embers). Source: CISA/NSA/FBI joint advisory AA26-194A, \"Improve Router Hygiene to Protect Against Russian State-Sponsored Targeting\" (2026-07-13). The advisory's core mitigations — MIB allow-list, management ACLs, SNMPv3 authPriv, out-of-band management — are exactly the \"normal\" this baseline measures, so building it doubles as hardening evidence.\n\nDATA COLLECTION FIELDS (per SNMP/management event): source (manager) IP, destination device, SNMP version (v1/v2c/v3), community string or v3 user (record presence of weak/default strings like `public`/`private`), request type (Get/GetNext/GetBulk/Set), OID(s) accessed — especially CISCO-CONFIG-COPY-MIB (1.3.6.1.4.1.9.9.96) and other config/sensitive MIBs, request volume/rate, source port, timestamp; and for config backups: source host, destination server, protocol (TFTP/SCP/FTP), filename, direction. TELEMETRY: SNMP agent/server logs on managed devices, device syslog (config-change / config-copy notifications, CISCO-CONFIG-MAN-MIB `ccmHistoryEventConfigSource`), NetFlow/IPFIX or firewall flow at the management boundary (UDP/161-162 SNMP, UDP/69 TFTP, TCP/4786 Smart Install).\n\nCOLLECTION WINDOW: 30 days per device to learn the stable, small set of legitimate managers, the SNMP version and OID scope each uses, and the normal config-backup source/destination pairs. DELIVERABLE: a per-device allow-list of expected SNMP managers (IP + version + OID scope) and expected config-backup flows (source NMS → destination server, protocol), plus an inventory of devices still permitting SNMPv1/v2c, default community strings, open UDP/69, or TCP/4786 — a direct remediation worklist.\n\nIMMEDIATE FLAGS (do not wait for the baseline to finish): (1) SNMP Set-Requests to any device, especially writes under CISCO-CONFIG-COPY-MIB `ccCopyTable` — legitimate management rarely uses SNMP Set to trigger config copies; (2) SNMP from a source IP not in the management allow-list, or from an external/spoofed-looking address; (3) reads of config/sensitive OIDs at high volume or from an unexpected source (MIB dump); (4) SNMPv1/v2c or default community strings on a device where v3 authPriv is expected; (5) an outbound TFTP/SCP/FTP config transfer from a device to a destination that appears in no known backup job. CROSS-REF: enables H235 (T1602.002 config exfiltration via SNMP-triggered TFTP copy) — that Flames hunt depends on this baseline to call an SNMP source \"unexpected\" or a transfer destination \"first-seen.\" T1602.001 (this SNMP MIB dump) is the recon twin of the T1602.002 config dump.",
    "tags": [
      "collection",
      "network_devices",
      "cisco",
  ...
  },
  {
    ...
    "created": "2024-10-09T15:45:42-07:00"
  },
  {
    "id": "H002",
    "category": "Flames",
    ...
    "created": "2024-09-01T09:16:19-07:00"
  },
  {
    "id": "H003",
    "category": "Flames",
    ...
    "created": "2024-09-29T23:13:15-05:00"
  },
  {
    "id": "H004",
    "category": "Flames",
    ...
    "created": "2024-10-05T10:32:41-07:00"
  },
  {
    "id": "H005",
    "category": "Flames",
    ...
    "created": "2024-10-05T12:37:32-07:00"
  },
  {
    "id": "H006",
    "category": "Flames",
    ...
    "created": "2024-10-22T11:04:58-06:00"
  },
  {
    "id": "H007",
    "category": "Flames",
    ...
    "created": "2024-10-20T11:10:46-04:00"
  },
  {
    "id": "H008",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2024-11-20T16:37:31-07:00"
  },
  {
    "id": "H010",
    "category": "Flames",
    ...
    "created": "2024-11-20T17:24:48-07:00"
  },
  {
    "id": "H011",
    "category": "Flames",
    ...
    "created": "2024-11-20T18:33:52-07:00"
  },
  {
    "id": "H012",
    "category": "Flames",
    ...
    "created": "2024-12-05T19:17:38-07:00"
  },
  {
    "id": "H013",
    "category": "Flames",
    ...
    "created": "2024-12-30T19:52:12-06:00"
  },
  {
    "id": "H014",
    "category": "Flames",
    ...
    "created": "2025-01-06T18:39:06-07:00"
  },
  {
    "id": "H015",
    "category": "Flames",
    ...
    "created": "2025-04-26T22:39:32-07:00"
  },
  {
    "id": "H016",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2025-06-24T14:35:25-07:00"
  },
  {
    "id": "H028",
    "category": "Flames",
    ...
    "created": "2025-06-24T14:37:00-07:00"
  },
  {
    "id": "H029",
    "category": "Flames",
    ...
    "created": "2025-06-24T14:37:31-07:00"
  },
  {
    "id": "H030",
    "category": "Flames",
    ...
    "created": "2025-06-24T14:37:59-07:00"
  },
  {
    "id": "H031",
    "category": "Flames",
    ...
    "created": "2025-06-24T14:40:31-07:00"
  },
  {
    "id": "H032",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-02-10T20:48:35-07:00"
  },
  {
    "id": "H066",
    "category": "Flames",
    ...
    "created": "2026-02-10T20:54:12-07:00"
  },
  {
    "id": "H067",
    "category": "Flames",
    ...
    "created": "2026-02-10T20:56:03-07:00"
  },
  {
    "id": "H068",
    "category": "Flames",
    ...
    "created": "2026-02-12T21:58:25-07:00"
  },
  {
    "id": "H069",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-02-17T22:29:32-07:00"
  },
  {
    "id": "H074",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-02-18T12:59:48-07:00"
  },
  {
    "id": "H077",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-02-20T22:07:03-07:00"
  },
  {
    "id": "H081",
    "category": "Flames",
    ...
    "created": "2026-02-25T05:19:13-07:00"
  },
  {
    "id": "H082",
    "category": "Flames",
    ...
    "created": "2026-02-27T03:07:32-07:00"
  },
  {
    "id": "H083",
    "category": "Flames",
    ...
    "created": "2026-03-04T01:12:51-07:00"
  },
  {
    "id": "H084",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-03-08T05:59:05-07:00"
  },
  {
    "id": "H086",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-03-10T05:03:22-07:00"
  },
  {
    "id": "H089",
    "category": "Flames",
    ...
    "created": "2026-03-10T05:04:11-07:00"
  },
  {
    "id": "H090",
    "category": "Flames",
    ...
    "created": "2026-03-11T10:44:29-07:00"
  },
  {
    "id": "H091",
    "category": "Flames",
    ...
    "created": "2026-03-15T09:01:57-07:00"
  },
  {
    "id": "H092",
    "category": "Flames",
    ...
    "created": "2026-03-18T14:13:49-07:00"
  },
  {
    "id": "H093",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-03-14T21:03:27-07:00"
  },
  {
    "id": "H098",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-04-19T15:59:28-05:00"
  },
  {
    "id": "H130",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-04-19T19:16:58-05:00"
  },
  {
    "id": "H137",
    "category": "Flames",
    ...
    "created": "2026-04-26T21:38:51-05:00"
  },
  {
    "id": "H138",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-05-06T13:58:30-05:00"
  },
  {
    "id": "H144",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-05-16T06:11:56-05:00"
  },
  {
    "id": "H153",
    "category": "Flames",
  ...
  },
  {
    ...
    "created": "2026-05-23T06:10:49-05:00"
  },
  {
    "id": "H162",
    "category": "Flames",
  ...
  },
  {
    ...
    "file_path": "Flames/H199.md",
    "created": "2026-06-20T07:14:58-05:00"
  },
  {
    "id": "H200",
    "category": "Flames",
    "title": "Threat actors are using DLL side-loading to force legitimate signed VirtualBox executables (DbgView.exe) to load malicious DLLs (vboxrt.dll) that download additional malicious code from attacker-controlled servers to evade security monitoring and achieve privileged code execution.",
    "tactic": "Defense Evasion",
    "notes": "Based on ATT&CK technique T1574.002. Generated by [hearth-auto-intel](https://github.com/THORCollective/HEARTH).",
    "tags": [
      "defense_evasion",
      "dll_sideloading",
      "virtualbox",
    ...
    "file_path": "Flames/H200.md",
    "created": "2026-06-18T14:25:11Z"
  },
  {
    "id": "H201",
    "category": "Flames",
    "title": "Adversaries are creating domain-level content compliance rules with regular expression patterns matching strategic intelligence keywords to silently BCC-forward emails to external attacker-controlled Gmail accounts for covert data exfiltration.",
    "tactic": "Collection",
    "notes": "Based on ATT&CK technique T1114.003. Generated by [hearth-auto-intel](https://github.com/THORCollective/HEARTH).",
    "tags": [
      "collection",
      "email",
      "china",
  ...
  },
  {
    "id": "H210",
    "category": "Flames",
    "title": "Threat actors are using PowerShell's `Add-Type` cmdlet with inline C# code containing `System.Windows.Forms.Clipboard.SetText()` to programmatically inject malicious Base64-encoded commands into victims' clipboards, bypassing traditional file-based payload delivery mechanisms.",
    "tactic": "Execution",
    "notes": "Based on ATT&CK technique T1059.001. Generated by [hearth-auto-intel](https://github.com/THORCollective/HEARTH).",
    "tags": [
      "execution",
    ...
    "file_path": "Flames/H210.md",
    "created": "2026-06-30T20:37:45+02:00"
  },
  {
    "id": "H211",
    "category": "Flames",
    "title": "Threat actors are sending unauthenticated HTTP GET requests to the WordPress REST API endpoint /wp-json/gravitysmtp/v1/tests/mock-data with the query parameter ?page=gravitysmtp-settings to exfiltrate API keys, OAuth tokens, and detailed system configuration data from sites running vulnerable Gravity SMTP plugin versions.",
    "tactic": "Collection",
    "notes": "Based on ATT&CK technique T1213. Generated by [hearth-auto-intel](https://github.com/THORCollective/HEARTH).",
    "tags": [
      "collection",
      "wordpress",
      "api",
    ...
    "file_path": "Flames/H211.md",
    "created": "2026-06-30T20:37:07+02:00"
  },
  {
    "id": "H212",
    "category": "Flames",
    "title": "Threat actors are distributing malware through malicious Google Ads that impersonate legitimate software brands to redirect users to attacker-controlled domains hosting OXLOADER and CASTLESTEALER payloads.",
    "tactic": "Initial Access",
    "notes": "Based on ATT&CK technique T1189. Generated by [hearth-auto-intel](https://github.com/THORCollective/HEARTH).",
    "tags": [
      "initial_access",
      "drive_by_compromise",
      "malvertising",
  ...
  },
  {
    ...
    "tactic": "Execution, Persistence, Stealth, Defense Impairment, Credential Access, Command and Control",
  ...
  },
  {
    "id": "H231",
    "category": "Flames",
    "title": "Threat actors are loading kernel modules inside guest VMs to exploit use-after-free vulnerabilities in KVM shadow MMU emulation, enabling guest-to-host escape and compromise of the underlying hypervisor host.",
    "tactic": "Privilege Escalation",
    "notes": "Based on ATT&CK technique T1611. Generated by [hearth-auto-intel](https://github.com/THORCollective/HEARTH).",
    "tags": [
      "privilegeescalation",
      "escape_to_host",
      "kvm",
  ...
  },
  {
    ...
    "created": "2024-07-17T14:02:03-07:00"
  },
  {
    "id": "M002",
    "category": "Alchemy",
    ...
    "created": "2024-09-01T14:35:38-07:00"
  },
  {
    "id": "M003",
    "category": "Alchemy",
    ...
    "created": "2024-10-12T18:09:55-07:00"
  },
  {
    "id": "M004",
    "category": "Alchemy",
    ...
    "created": "2024-10-13T10:04:43-07:00"
  },
  {
    "id": "M005",
    "category": "Alchemy",
    ...
    "created": "2024-10-22T11:03:44-06:00"
  },
  {
    "id": "M006",
    "category": "Alchemy",
    ...
    "created": "2024-11-20T16:24:09-07:00"
  },
  {
    "id": "M007",
    "category": "Alchemy",
    ...
    "created": "2024-11-20T17:35:35-07:00"
  },
  {
    "id": "M008",
    "category": "Alchemy",
    ...
    "created": "2026-02-13T22:38:36-07:00"
  },
  {
    "id": "M014",
    "category": "Alchemy",
  ...
  },
  {
    ...
    "file_path": "Alchemy/M022.md",
    "created": "2026-06-20T07:14:58-05:00"
  },
  {
    "id": "M023",
    "category": "Alchemy",
    "title": "A per-identity baseline over Windows authentication events (NTLM and Kerberos network logons) can distinguish a compromised credential moving laterally from legitimate accounts, by modeling each source account's normal set of distinct destination hosts and flagging windows where authentication breadth — distinct destination-host fan-out — spikes far above that account's own rolling baseline. Because service and automation accounts legitimately authenticate to hundreds of hosts, a global fan-out threshold is unworkable in both directions; a per-user robust baseline (median + k*MAD of distinct-host count) surfaces credential spread while tuning the always-busy service account out.",
    "tactic": "Lateral Movement",
    "notes": "ALCHEMY ANALYTIC — per-identity baseline, not a static rule. Platform: Windows / Active Directory (on-prem authentication). **Attacker pattern**: once an adversary captures a credential or hash, lateral movement fans the same account across many destination hosts it never normally touches — pass-the-hash (NTLM network logons) and Kerberos service-ticket use across the estate. In the LANL Unified Host & Network red-team data this is unmistakable: 104 compromised accounts touch a median of 20 distinct destination hosts (max 198) during the operation, versus a median of 1 for benign users in the same window — but a handful of benign service accounts legitimately reach thousands of hosts, which is exactly why a static org-wide cutoff fails. **Data sources**: Windows Security Event Log 4624 (logon; focus LogonType 3 = network), 4625 (failed logon), 4768/4769 (Kerberos TGT/TGS), or domain-controller authentication; the LANL `auth.txt` schema (time, source user@domain, destination user@domain, source computer, destination computer, auth type, logon type, auth orientation, success/failure) is a faithful research stand-in. Required fields: timestamp, source account, source host, destination host, auth type (NTLM/Kerberos), logon type, success. **Feature engineering** (per source account, sliding daily/hourly window): (1) `distinct_dst_hosts` = dcount(destination host) — the primary breadth signal; (2) `auth_volume` = total logon count (the foil dimension — volume alone cannot separate a chatty service account from a spreading credential); (3) `new_host_fraction` = share of destination hosts not seen for this account in its prior 30-day history (novelty); (4) `ntlm_network_fraction` = share of NTLM LogonType-3 events (pass-the-hash tell, T1550.002); (5) `failure_ratio` = 4625/(4624+4625) (spray/guessing corroborator). **Model approach**: fit a per-account robust baseline of `distinct_dst_hosts` over a rolling 30-day window using median + k*MAD (robust to a single busy day poisoning the baseline; mean+stddev inflates and goes blind), and flag windows where breadth exceeds the account's own envelope. A global threshold is the explicit foil: any cutoff low enough to catch a compromised user's 20-host fan-out also fires on every legitimate vulnerability-scanner, SCCM, or backup service account. **Fire conditions**: alert when `distinct_dst_hosts` exceeds the account's baseline envelope AND (`new_host_fraction` high OR `ntlm_network_fraction` high). **Tuning**: maintain a per-environment allowlist of known wide-reach service principals (scanners, patch management, monitoring, backup) and seed their baselines; apply a cold-start guard so a newly-onboarded account is not flagged until it has accrued baseline history. Cross-reference **T1550.002** (Use Alternate Authentication Material: Pass the Hash — the NTLM network-logon spread) and **T1078** (Valid Accounts — the captured credential is the precondition).",
    "tags": [
      "lateral_movement",
      "authentication",
      "ntlm",
  ...
  },
  {
    ...
    "tactic": "Command and Control",
    "notes": "ALCHEMY ANALYTIC — volumetric / behavioral network anomaly detection for ORB relay activity. PLATFORM: network (edge / embedded Linux). Source: Cisco Talos UAT-7810, which builds ORB networks from compromised Ruckus and ASUS edge devices using LONGLEASH (Boost.Asio proxy for HTTP/DNS/SOCKS/TCP/ICMP/UDP) and DOGLEASH backdoors.\n\nPROBLEM: ORB nodes are legitimate perimeter devices, so a static IOC/signature list ages out as infrastructure rotates. The durable signal is the CHANGE in a device's role — a gateway that has only ever originated its own management/update traffic starting to relay third-party sessions. This is an anomaly-modeling problem, not a signature match.\n\nDATA SOURCES: NetFlow/IPFIX or firewall/gateway flow logs at the perimeter; per-device inbound/outbound connection records; passive DNS; TLS/JA3 metadata. REQUIRED FIELDS: source device, direction, dst/src port, bytes in/out, connection count, distinct external peers, protocol, timestamp.\n\nFEATURES per perimeter device over a rolling baseline (~30 days): count of inbound connections on non-service / high ports; ratio and temporal correlation of inbound-to-outbound sessions (relay = tight inbound⇄outbound pairing); distinct external-peer fan-in and fan-out; proxied-protocol mix (SOCKS/HTTP/DNS/ICMP tunneling); bytes-relayed vs bytes-terminated. MODEL: per-device baseline + outlier scoring (robust z-score / isolation forest) on the relay-shape features; alert on a device crossing from \"terminator\" to \"relay\" behavior. UAT-7810 observed pivots: listeners on ports 99 (TLS), 2222 (C2), 8088; relay IPs 194.233.92[.]26, 217.15.160[.]247, 217.15.164[.]147, 95.182.100[.]231.\n\nHIGH-FIDELITY JOIN (near-signature): self-signed TLS certificate with every X.509 field set to the literal string `exploit` (`C=exploit, ST=exploit, L=exploit, O=exploit, OU=exploit, CN=exploit`), fingerprint `c2ab9adaba93ff094b8f3fc37d906014d870582039d276b7bd03e6fd583d8a15`, and a spoofed `Mozilla/5.0 (Windows NT 10.0...)` User-Agent egressing from a Linux/embedded device — use as a corroborating feature to promote a scored anomaly to an alert.\n\nVALIDATION / TUNING: backtest against known-good change windows (firmware updates, new site links) to set the outlier threshold; monitor per-device drift; treat sanctioned proxies/VPN concentrators as an allowlist. NAIVE FOIL: alerting on any inbound high-port connection — provably noisy on internet-facing devices; the separating signal is the inbound⇄outbound relay CORRELATION, not inbound alone. CROSS-REF: complements external-proxy/relay IOC hunts; the ORB device is often the pivot upstream of the T1132.001 encoded-C2 hunt.",
    "tags": [
      "command_and_control",
      "network",
      "orb",
  ...
  },
  {
    ...
    "tactic": "Collection",
    "notes": "ALCHEMY ANALYTIC — per-user / per-connected-app volumetric anomaly detection on CRM data access. PLATFORM: SaaS (Salesforce), surfaced via Microsoft Defender for Cloud Apps CloudAppEvents and Salesforce Event Monitoring / Event Log Files (ELF). Source: Microsoft, \"Defending SaaS-based applications against ShinyHunters OAuth abuse\" (2026-07-13), which notes the activity \"appeared indistinguishable from legitimate Salesforce usage\" and that effective detection requires spotting *anomalous* export/enumeration volume, not any single event.\n\nWHY MODEL-ASSISTED (not a static rule): report exports and SOQL queries are routine for sales/ops users, and ShinyHunters deliberately paces exfiltration (\"slow exfiltration\") to stay under fixed thresholds. The separating signal is the deviation from a given user's/app's own history — a volumetric/behavioral problem, not a signature.\n\nDATA SOURCES / FIELDS: CloudAppEvents where Application == \"Salesforce\", ActionType in (\"ReportExport\",\"ApiTotalUsage\",\"UniqueQuery\",\"API Event\"); RawEventData fields `USER_ID`, `CONNECTED_APP_ID`, `CONNECTED_APP_NAME`, `QUERY_IDENTIFIER` (SOQL text/object), plus IPAddress, UserAgent. Salesforce ELF event types `ReportExport`, `API`, `BulkApi`, `RestApi` give row counts and durations for finer volume features.\n\nFEATURES per user AND per connected app over a rolling baseline (~30 days): count and summed row-volume of `ReportExport`; distinct high-value objects queried (Accounts/Contacts/Cases/Opportunities); SOQL query rate; ratio of read/export volume to that identity's historical mean; export activity outside business hours; export from an IP/user-agent first-seen for that identity; share of total-org export volume concentrated in one app/user. MODEL: per-entity baseline + robust outlier scoring (z-score / MAD or isolation forest) on the volume and breadth features; alert when an entity crosses from its normal envelope into sustained high-volume export, especially when the ConnectedAppId is itself first-seen (join to H227).\n\nANCHOR QUERY (report-export volume by user, from the source report):\n  CloudAppEvents\n  | where Application == \"Salesforce\"\n  | where ActionType == \"ReportExport\"\n  | extend SalesforceUserId = tostring(RawEventData.USER_ID)\n  | summarize Events = count() by AccountObjectId, AccountId, AccountName, SalesforceUserId, IPAddress, UserAgent\n\nVALIDATION / TUNING: backtest against known heavy-reporting periods (quarter-end, data-migration projects) to set thresholds; maintain per-entity drift; allowlist sanctioned ETL/integration service accounts by ConnectedAppId (but keep them baselined — a compromised vendor app, e.g. Salesloft/Gainsight, is exactly the supply-chain path in the report). NAIVE FOIL: a fixed \"N exports/day\" threshold — provably bypassed by paced exfil and noisy for power users; the separating signal is deviation from the entity's own baseline plus first-seen app/IP breadth. CROSS-REF: H234 (T1671) is the consent/foothold half — the connected app that consents there is the one whose export volume spikes here; also cross-ref T1567 (exfil over web service) for the outbound leg.",
    "tags": [
      "collection",
      "saas",
      "salesforce",
