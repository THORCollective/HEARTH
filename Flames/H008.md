...
|------------------|----------------------------------------------------------------------------------------------------|-----------------------|-------------------------------------------|-----------------------------------------|--------------------|
| H008 | Adversaries may create domain accounts to maintain access to systems with Active Directory. | Persistence | Domain Accounts can cover user, administrator, and service accounts. | #Persistence #ActiveDirectory #T1136_002 | [Audra Streetman](https://x.com/audrastreetman) |
